...
const prompt = `Generate exactly 25 Chinese dish entries for: 早餐、街头小吃、面食、包子饺子 (breakfast, street food, noodles, dumplings).
Number them dish_126 to dish_150.
Output ONLY a valid JSON array, no explanation, no markdown.
Each item schema:
{"id":"dish_126","chineseName":"...","englishName":"...","pinyin":"...","cuisine":"Street Food","ingredients":["..."],"allergens":[],"spicyLevel":0,"vegetarianFriendly":false,"veganFriendly":false,"commonRegion":["nationwide"],"shortDescription":"max 10 words","orderTip":"max 15 words","avoidIf":[]}`;

async function main() {
  console.log('Generating dish_126 to dish_150...');
