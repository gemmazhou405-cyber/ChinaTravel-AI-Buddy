import { AlertTriangle, Building2, Car, ChevronRight, CreditCard, Key, Lock, MapPin, MessageSquare, Plane, Utensils, Wifi } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1">
                {selectedCity.transport.tips.map((tip) => (
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500">Food streets: {selectedCity.food.foodStreets.join(', ')}</p>
              <ul className="mt-2 space-y-1">
                {selectedCity.food.tips.map((tip) => (
                  <li key={tip} className="text-xs text-gray-500">• {tip}</li>
                ))}
              </ul>
            </div>
