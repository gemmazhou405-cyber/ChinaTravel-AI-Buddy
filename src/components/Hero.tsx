...
export default function Hero({ user, userState, onAuthClick, onLogout }: Props) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 py-3 md:px-10 md:py-5">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-end md:items-center justify-between px-6 pb-16 pt-32 md:px-10 md:pb-24 max-w-7xl mx-auto w-full md:mb-0 mb-[33vh]">
